...
summary(gbmA.fit$finalModel, las = 2, cBars = 11, cex.names = 0.6)
...
svml.pred <- predict(svml.fit, newdata = dat[-rowTrain,], type = "prob")[,1]
svmr.pred <- predict(svmr.fit, newdata = dat[-rowTrain,], type = "prob")[,1]
rpart.pred <- predict(rpart.fit, newdata = dat[-rowTrain,], type = "prob")[,1]
